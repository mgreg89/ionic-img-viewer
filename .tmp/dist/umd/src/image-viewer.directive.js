(function (factory) {
    ...
    var ImageViewerDirective = (function () {
        ...
        ImageViewerDirective.prototype.onClick = function (event) {
            ...
            var imageViewer = this.imageViewerCtrl.create(element, { fullResImage: this.src, onCloseCallback: onCloseCallback, picture: this.picture, gamepicturerelation: this.gamepicturerelation });
            imageViewer.present();
        };
        ...
        ImageViewerDirective.propDecorators = {
            ...
            "picture": [{ type: core_1.Input },],
            "gamepicturerelation": [{ type: core_1.Input },],
